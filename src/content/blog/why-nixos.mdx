...
draft: false
title: "Why NixOS?"
description: "There are valid reasons behind my preference for NixOS over Arch Linux, even though Arch might be trending currently. NixOS offers a unique approach to system management that appeals to me"
